module github.com/lccro/quicklogs

go 1.12

replace github.com/Sirupsen/logrus => github.com/sirupsen/logrus v1.2.1-0.20181215152119-2067ea4241ce

replace github.com/docker/distribution => github.com/docker/distribution v0.0.0-20190711223531-1fb7fffdb266

replace github.com/docker/distribution/digest => github.com/opencontainers/go-digest v1.0.0-rc1
...
require (
	...
	github.com/docker/cli v0.0.0-20190824002126-058a4af0bdb4
	github.com/docker/distribution v0.0.0 // indirect
	github.com/docker/docker v0.7.3-0.20190825014646-cd1356d9ea63
